...
- **Data Boundary**: Local by default, with zero product telemetry collected by Order Samurai. All metric aggregation, secret scrubbing, and kill-chain analysis happen on your local filesystem (`~/.samurai/`).
