...
// Exported 2026-08-24 so the BrAIn3 media gallery can render these same assets with THIS
// renderer instead of a second, divergent copy. Additive only — the React <AsciiObject>
// wrapper below is unchanged and remains the in-app entry point. The vanilla instance API
// (AsciiObjectInstance: setOptions/resize/destroy) was already designed and documented for
// exactly this kind of use; it just had no export.
